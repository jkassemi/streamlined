module Streamlined::Controller::CrudMethods
  ...
  def list
    ...
    model_pages,models = nil,nil
    
    # load default conditions
    # ActiveRecord::Base.const_get(model_name).method(:with_scope).call(:find => model_ui.default_filter_options.call) do
    ...
    self.instance_variable_set("@#{ActiveSupport::Inflector.tableize(model_name.variableize)}", models)
  ...
  def order_options
    ...
    if model.column_names.include? sort_column
      active_record_order_option(model_name)
    else
