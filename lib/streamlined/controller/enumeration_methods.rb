module Streamlined::Controller::EnumerationMethods
  ...
  def edit_enumeration
    ...
    render_streamlined_file(rel_type.edit_view.partial_with_underscore, :locals => {:item => instance, :relationship => rel_type})
  end
  ...
  def show_enumeration
    ...
    render_streamlined_file(rel_type.show_view.partial_with_underscore, :locals => {:item => instance, :relationship => rel_type})
  end
