module Streamlined::View::ShowViews
  ...
  # Renders the streamlined_name of the last element of the other end of the relationship.  Used for one-to-n relationships.
  class Last < Streamlined::View::Base
    
  end
  
  class ListWithInsert < Streamlined::View::Base
    
  end
  
  class WithPartial < Streamlined::View::Base
