...
ACTUAL_PATH = File.expand_path(File.join(STREAMLINED_RAILS_ROOT, "/vendor/plugins/multi_rails/bin/multi_rails_runner.rb"))

puts BAR
puts "Installing multi_rails, and settig up /script/multi_rails_runner."

FileUtils.symlink(ACTUAL_PATH, RUNNER_PATH, :force => true)
`chmod +x #{STREAMLINED_RAILS_ROOT}/script/multi_rails_runner`
