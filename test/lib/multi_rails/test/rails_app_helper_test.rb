...
describe "running a task" do
  setup { Object.const_set("STREAMLINED_RAILS_ROOT", "/src/rails_app")}
  teardown { Object.send(:remove_const, "STREAMLINED_RAILS_ROOT")}
...
describe "determing rails root" do
  teardown { Object.send(:remove_const, "STREAMLINED_RAILS_ROOT") if Object.const_defined?("STREAMLINED_RAILS_ROOT")}
  
  it "should try the STREAMLINED_RAILS_ROOT constant first" do
    Object.const_set("STREAMLINED_RAILS_ROOT", "/src/rails_app")
    MultiRails::RailsAppHelper.set_STREAMLINED_RAILS_ROOT.should == "/src/rails_app"
  end
  ...
  it "should fallback to finding it dynamically" do
    ...
    MultiRails::RailsAppHelper.set_STREAMLINED_RAILS_ROOT.should == "/foo/bar/my_rails_app"
  end
  
  it "should fail fast if it can't determine RAILS ROOT" do
    MultiRails::RailsAppHelper.expects(:find_STREAMLINED_RAILS_ROOT_dir).returns(nil)
    lambda { MultiRails::RailsAppHelper.set_STREAMLINED_RAILS_ROOT }.should.raise
  end
...
describe "writing rails gem version file" do
  ...
  it "should write to the correct file" do
    File.expects(:open).with("#{STREAMLINED_RAILS_ROOT}/config/rails_version.rb", 'w')
...
describe "init for rails app" do
  it "should set rails root, write rails gem version file, and rename vendor rails" do
    version = "1.2.6"
    MultiRails::RailsAppHelper.expects(:set_STREAMLINED_RAILS_ROOT)
...
describe "renaming vendor/rails if it exists" do
  ...
  it "should rename with .OFF extension so that gem version is picked up during test run" do
    vendor_rails = "#{STREAMLINED_RAILS_ROOT}/vendor/rails"
...
EOL
  ...
  teardown do
    Object.send(:remove_const, "STREAMLINED_RAILS_ROOT")
  end
